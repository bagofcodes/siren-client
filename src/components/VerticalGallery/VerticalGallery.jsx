    ...
    return (
        <div className='galContainer'>
            ...
            <>
                ...
                <img className='imgBig' src={IURL+posts[0].photo} alt="" onClick={()=>{navigate(`/singlePost/${posts[0]._id}`);}} />
            ...
            <div className="smallContainer">
                <div className="smallCon">
                    <img className='imgBig' src={IURL+posts[1].photo} alt="" onClick={()=>{navigate(`/singlePost/${posts[1]._id}`);}} />
                ...
                <div className="smallCon">
                    <img className='imgBig' src={IURL+posts[2].photo} alt="" onClick={()=>{navigate(`/singlePost/${posts[2]._id}`);}} />
