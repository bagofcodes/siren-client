    ...
    return (
        <div className='postsSidebarcontainer'>
            ...
            {isFetched?null : <><div className='topBig'>
                <img className="imgTb" src={IURL+posts[0].photo} alt="" onClick={()=>{navigate(`/singlePost/${posts[0]._id}`);}}/>
            ...
            <div className="smalltn">
                <img className="imgTs" src={IURL+posts[1].photo} alt="No internet" onClick={()=>{navigate(`/singlePost/${posts[1]._id}`);}}/>
            ...
            <div className="smalltn">
                <img className="imgTs" src={IURL+posts[2].photo} alt="No internet" onClick={()=>{navigate(`/singlePost/${posts[2]._id}`);}} />
                <div className='titleTs'>
            ...
            <div className="smalltn">
                <img className="imgTs" src={IURL+posts[3].photo} alt="No internet" onClick={()=>{navigate(`/singlePost/${posts[3]._id}`);}} />
                <div className='titleTs'>
